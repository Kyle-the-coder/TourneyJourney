...
<body class="bg-dark">
	...
	<section class="bg-warning border-top border-bottom border-3">
		<div class="about p-3">
			...
			<div class="about_img_p">
				<img src="<c:url value="/imgs/smashbros.jpeg"/>" alt="winning trophy" class="about_img rounded"/>
				<img src="<c:url value="/imgs/dancebg1.png"/>"  alt="dance comp" class="img_1 rounded" />
			</div>
		</div>
	</section>
	...
	<section class="p-3">
		<div class="direction text-white">
			<h2 class="direction_text_1">Register or Log in </h2>
		</div>
	</section>

...
<body class="bg-dark">
	...
	<div class="main_content my-3">
		...
		<section class="create_event border border-warning border-3 p-3">
			<div>
				<h3 class="p-3 bg-warning direction_text rounded border border-3 border-dark">Edit Your Event</h3>
				<form:form action="/update/event/${ editEvent.id }" class="form" method="POST" modelAttribute="editEvent">
				<input type="hidden" name="_method" value="PUT">
					...
					<form:hidden path="event_participants"/>
					<form:hidden path="users_liked"/>
					
					<form:button type="submit" class="p-2 my-2 rounded bg-warning table_shadow border border-2 border-dark">Submit</form:button>
